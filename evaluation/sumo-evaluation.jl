...
# TODO go over all data and adjust accordingly
...
# TODO does not yet work due to the global variable in the second loop
...
for file_name in files
    global all_data  # Explicitly state that all_data is a global variable
    try
...
for file_name in stats_files
    global stats_all_data  # Explicitly state that stats_all_data is a global variable
    try
        #print(file_name)
		df = DataFrame(CSV.File(file_name))

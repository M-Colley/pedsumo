...
pythonPath = "/usr/bin/python3"  # prompt to use Python on your computer in the command line
xml2csvPath = "/usr/local/Cellar/sumo/1.17.0/share/sumo/tools/xml/xml2csv.py"  # prompt to use xml2csv.py in your sumo folder on your computer as command line argument
...
for xmlFile in xml_files:
    if xmlFile not in exclude_files:
        ...
        if xmlFile in ["stats.xml", "most.stats.xml"]: # if stats file doesnt seem to convert properly, remove it from this list
